...
import  {Carousel, CarouselItem } from 'mdbreact';
import { Mask, Row, Col, Button, View, Container } from 'mdbreact';

const handleSignUp = () => Turbolinks.visit('/users/sign_up') //DEFINES WHERE GET STARTED LINK TAKES THE USER
const handleSignIn = () => Turbolinks.visit('/users/sign_in') //DEFINES WHERE LOG IN LINK TAKES THE USER
