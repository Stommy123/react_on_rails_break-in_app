...
const CurrentUserScore = ({points}) => (
  ...
  <Card className="UserCard1">
    <div className="text-white text-center d-flex align-items-center rgba-cyan-strong py-5 px-4">
      <div className="cardBody">
        <h5 className="pink-text"><Fa icon="pie-chart" /></h5>
  ...
  <Card className="UserCard" style={{backgroundImage: "url('https://mdbootstrap.com/img/Photos/Horizontal/City/6-col/img%20(47).jpg')"}}>
    <div className="text-white text-center d-flex align-items-center rgba-grey-strong py-5 px-4">
      <div className="cardBody">
        <h5 className="orange-text"><Fa icon="desktop" /></h5>
  ...
  <Card className="UserCard">
    <div className="text-white text-center d-flex align-items-center rgba-cyan-strong py-5 px-4">
      <div className="cardBody">
        <h5 className="pink-text"><Fa icon="area-chart" /></h5>
